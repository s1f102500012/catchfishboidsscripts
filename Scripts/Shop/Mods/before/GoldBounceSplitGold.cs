...
[CreateAssetMenu(menuName = "CatchFish/Modifier/0917/10% split GOLD when GOLD bounces")]
public class GoldBounceSplitGold : PlayerModifier
{
    [Range(0f,1f)] public float baseChance = 0.10f;
    public float backOffset = 0.6f;   // 生成点沿反方向后撤
