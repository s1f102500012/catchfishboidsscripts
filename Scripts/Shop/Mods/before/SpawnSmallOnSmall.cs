...
[CreateAssetMenu(menuName = "CatchFish/Modifier/20% Spawn Small on Small")]
public class SpawnSmallOnSmall : PlayerModifier
{
    ...
    public override void Apply(PlayerController player)
    {
        ...
        if (!sHooked) { GlobalEvents.OnSmallFishEaten += OnSmall; sHooked = true; }
    }
    ...
    public static void HardReset()
    {
        ...
        if (sHooked){ GlobalEvents.OnSmallFishEaten -= OnSmall; sHooked = false; }
    }
}
